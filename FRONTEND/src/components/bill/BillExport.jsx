        ...
        {showTitle && (
          <div className="text-center mb-6 border-b-2 border-gray-800 pb-4">
            <h1 className="text-3xl font-bold mb-2">
              Bill Ngày: {formatDate(billData.date)}
            </h1>
          </div>
        )}
        ...
        <div className="mb-6 grid grid-cols-5 gap-4 bg-gray-50 p-4 rounded-lg">
          <div className="col-span-1">
            ...
            <div className="text-lg font-semibold">
              {formatCurrencyRounded(billData.court_total)}
            </div>
          </div>
              ...
              {billData.bill_shuttles && billData.bill_shuttles.length > 0 ? (
                <div className="space-y-1">
                  {billData.bill_shuttles.map((shuttle, index) => (
                    <div key={index}>
                      {shuttle.shuttle_type?.name} × {shuttle.quantity} ={" "}
          ...
          <div className="col-span-1">
            ...
            <div className="text-xl font-bold text-blue-600">
              {formatCurrencyRounded(billData.total_amount)}
            </div>
          </div>
          <div className="col-span-1">
          ...
          <table className="w-full border-collapse text-sm">
            ...
            <tbody>
              {(() => {
                ...
                const sortedPlayers = [...(billData.bill_players || [])].sort(
                  (a, b) => {
                ...
                return sortedPlayers.map((player, index) => {
                  ...
                  const isMainBill =
                    subBills !== null && subBills !== undefined;
                  const shouldShowGreenForTotal =
                    isMainBill &&
                    (!subBills.length ||
                      (!hasSubBillWithMoney && subBills.length > 0));
                  ...
                  return (
                    <tr key={player.id}>
                      ...
                      <td
                        className={`border border-gray-300 px-3 py-2 text-right font-semibold ${shouldShowGreenForTotal ? "text-green-600" : ""}`}
                      >
        ...
        <div className="space-y-4">
          {activeAccounts.map((account) => {
            ...
            const isBase64 =
              ...
              account.qr_code_image.startsWith("data:image/");
            ...
            const imageSrc =
              base64Image ||
              (isBase64 ? account.qr_code_image : null) ||
              account.qr_code_image_url ||
              (account.qr_code_image
                ? `${window.location.origin}/storage/${account.qr_code_image}`
                : null);
                ...
                {account.qr_code_image && imageSrc && (
                  <div className="mt-3 w-full">
                    <img
                      ...
                      crossOrigin={
                        isBase64 || base64Image ? undefined : "anonymous"
                      }
                      loading="eager"
  ...
  if (hasSubBills) {
    return (
      <div
        ...
        style={{ fontFamily: "Arial, sans-serif", maxWidth: "1728px" }}
      >
        <div className="grid grid-cols-2 gap-6">
          {/* Cột trái: Bill chính */}
          <div className="col-span-1">
            {renderBillContent(bill, true, bill.sub_bills || [])}
          </div>
